...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChartValuesFrom) DeepCopyInto(out *ChartValuesFrom) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChartValuesFrom.
func (in *ChartValuesFrom) DeepCopy() *ChartValuesFrom {
	if in == nil {
		return nil
	}
	out := new(ChartValuesFrom)
	in.DeepCopyInto(out)
	return out
}
